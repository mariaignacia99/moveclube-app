...
#ifndef MOVECLUB_SWIFT_H
#define MOVECLUB_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MoveClub",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8MoveClub11AppDelegate")
...
@class UIScene;
SWIFT_CLASS("_TtC8MoveClub13SceneDelegate")
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC8MoveClub14ViewController")
