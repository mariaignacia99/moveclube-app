...
def seed_data(conn):
    ...
    class_templates = [
        ...
        (studio_ids["Bull Pádel Center Osorno"], instructor_ids["Gonzalo Arismendi"], "Clínica de Pádel: Bandeja & Víbora", "Pádel", 60, 10, 4, "Perfeccionamiento técnico de golpes de fondo y voleas con profesor especializado.", "Todos los niveles"),
        (studio_ids["Bull Pádel Center Osorno"], instructor_ids["Gonzalo Arismendi"], "Rey de la Pista Nocturno (Cupo Individual)", "Pádel", 90, 7, 4, "Partidos rápidos rotativos nivelados en cancha central panorámica con tercer tiempo.", "Todos los niveles"),
